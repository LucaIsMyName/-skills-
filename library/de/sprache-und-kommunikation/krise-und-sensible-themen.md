...
- **Bestätigte Fakten** vs. **Unbekanntes** (extern nur Bestätigtes, außer Nutzer legt anderes fest)
- **Kanäle** (Web, Social, Presse)
- **Benannte Ansprechpersonen** und **Medienkontakt**
- **Vorhandene Leitungstexte** (falls vorhanden: einfügen)

### Meta

- **Schweregrad** (Sicherheit, Recht, Reputation)
- **Zielgruppe** (Öffentlichkeit, Betroffene, Spenderinnen, Team)
- **Tabus** (laufende Ermittlungen, Minderjährige, …)

---

## Grundregeln

### 1. Wann Publikationen pausieren
...
### 3. Hinweis für die KI an Nutzerinnen

Wenn öffentliche Texte ohne Freigabekontext angefragt werden, **ausdrücklich** auf **Abstimmung mit Leitung/Kommunikation** hinweisen.

---

### 4. Mitgefühl ohne voreilige Schuldzuweisung

Betroffenheit **anerkennen**, ohne Schuld zu verteilen, bevor Fakten vorliegen.

---

## Checkliste vor externer Veröffentlichung

- [ ] Genannte Fakten sind in der Organisation **bestätigt**
- [ ] Keine Spekulation, keine Namen ohne Freigabe
- [ ] Medien an **freigegebene** Ansprechperson verwiesen
- [ ] **Freigabe** durch Kommunikation/Leitung (vom Nutzer zu bestätigen)
- [ ] Geplante Beiträge geprüft oder pausiert
