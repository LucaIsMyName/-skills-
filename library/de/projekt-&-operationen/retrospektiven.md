...
- **Facilitation** rotieren.
- **Follow-up** in der nächsten Retro.

## Vor der Retro

### Konkret

- **Scope** welches Projekt/Zeitraum?
- **Teilnehmende**, die mitgearbeitet haben.

### Meta

- Retros ohne **Follow-through** züchten Zynismus.

---

## Zweck

Erfahrung in **besseres Handeln** verwandeln—**sichtbar**.

---

## 1. Psychologische Sicherheit und Grenzen
...
## 2. Auf Daten stützen, nicht nur Meinung
...
## 5. Vorherige Maßnahmen zu Beginn prüfen
...
## 6. Zeitbox und einfaches Format
...
- **Schuld** als „Ehrlichkeit“ getarnt—Leute kommen nicht mehr oder sagen nur noch Harmloses.
- **Maßnahmen-Inflation**—zehn Punkte, keine Kapazität; nichts ändert sich.
- **Kein Follow-up**—jeden Monat dieselben Klagen; Zynismus wächst.
- **Falscher Scope**—Retro über alles; keine gemeinsame Erfahrung der Beteiligten.
...
- [Agile Alliance — Retrospective](https://www.agilealliance.org/glossary/heartbeat-retrospective/) — klassisches Framing
- [Google re:Work — Psychological safety](https://rework.withgoogle.com/guides/understanding-team-effectiveness/steps/introduction/) — warum Sicherheit fürs Lernen zählt
- [Atlassian — Sprint retrospectives](https://www.atlassian.com/agile/scrum/sprint-retrospective) — Facilitation-Grundlagen

---

Englische Version: [`retrospectives.md`](../../en/project-&-operations/retrospectives.md)
