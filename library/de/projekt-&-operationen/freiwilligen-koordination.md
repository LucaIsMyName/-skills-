...
- **Anerkennung** angemessen—Dank und **Referenzen** (mit Einwilligung).
- **Schutzregeln** für Rollen mit vulnerablen Personen **vorweg**.

## Vor Rekrutierung

### Konkret

- **Aufsicht**—wer ist erreichbar?
- **Versicherung**, **Führungszeugnis** o. Ä. nach Rolle—**Recht** klärt.

### Meta

- Freiwillige brennen aus an **Chaos**, nicht an Arbeit.

---

## Zweck

Engagement **haltbar** machen—**klar**, **sicher**, **gewürdigt**.

---

## 1. Rollenprofile mit Zeit und Skills
...
## 2. Dienste und Vertretung—kein Single Point of Failure
...
## 5. Anerkennung und Referenzen (mit Einwilligung)
...
## 6. Schutz und Prüfungen von Anfang an
...
- **Vages** „Helft uns“-Rekrutieren—falsche Menschen, schnelles Aus, Frust.
- **Helden-Abhängigkeit**—eine Person hat alle Schlüssel/Wissen; Burnout oder Bus-Faktor.
- **Schuldgefühle** für Extra-Stunden—frisst Vertrauen und rechtliche Balance.
- **Schutz** als Nachgedanke—Vorfälle werden Krisen und rechtliches Risiko.
...
- [NCVO — Volunteering](https://www.ncvo.org.uk/help-and-guidance/) — UK-Rahmen; lokal adaptieren
- [GOV.UK — Safeguarding](https://www.gov.uk/government/publications/safeguarding-guidance) — Grundsätze; mit lokaler Policy kombinieren
- [Volunteer.gov](https://www.volunteer.gov/) — US-Bundes-Freiwilligen-Hub—Ideen zur Rollenklarheit lokal anpassen

---

Englische Version: [`volunteer-coordination.md`](../../en/project-&-operations/volunteer-coordination.md)
