...
- **Publikum**; **Länge**.
- Welche **Entscheidungen** diese Woche?

### Meta

- **Alles grün** bis zur Explosion vermeiden—**früh gelb**.

---

## Zweck

Fortschritt und Probleme **sichtbar** machen—**Hilfe** rechtzeitig.

---

## 1. Ampel oder G/Y/R mit Schwellen
...
## 3. Asks: Entscheidung, Ressource, Risikoakzeptanz
...
## 5. Archiv, wo Neue Historie lesen
...
- **Grün-Färbung** aus Angst—Blocker werden bis zum Launch versteckt.
- **Kennzahlensalat**—zehn KPIs ohne Story; niemand weiß, was zählt.
- **Kein Ask**—Stakeholder lesen und zucken mit den Schultern; Blocker wiederholen sich.
- **Uneinheitliche** Ampel-Definition—die Hälfte denkt, Gelb sei „alles ok“.
...
- [Atlassian — Status reports](https://www.atlassian.com/work-management/project-management/status-reports) — pragmatische Struktur
- [GOV.UK — Reporting progress](https://www.gov.uk/service-manual/agile-delivery/reporting-progress) — Fortschritt im RAG-Stil
- [Harvard Business Review — Communication](https://hbr.org/topic/subject/communication) — Artikel gezielt wählen; Normen unterscheiden sich je Organisation

---

Englische Version: [`status-updates-and-reporting.md`](../../en/project-&-operations/status-updates-and-reporting.md)
