...
- **Timeline** mit **Abhängigkeiten** (Recht, Assets, Übersetzung).
- **Evaluation**: Baselines, Tracking, **Retro**-Termin.

## Vor dem Launch

### Konkret

- **Asset-Liste**; **Freigaben**.
- **Risiko**-Register.

### Meta

- Kampagnen scheitern an **Handoffs**, nicht am Slogan.

---

## Zweck

Koordiniert liefern und **lernen**—kein Einmal-Rauschen.
...
Englische Version: [`campaign-planning.md`](../../en/project-&-operations/campaign-planning.md)
