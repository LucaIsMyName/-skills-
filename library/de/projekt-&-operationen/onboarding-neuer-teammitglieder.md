...
- **Single source of truth**—Links, Owner.
- **Feedback** früh—Onboarding **verbessern**.

## Vor Tag 1

### Konkret

- **Hardware/Software**; **Zugänge** beantragt.
- **Termine**—nicht ohne Pausen vollkitten.

### Meta

- Onboarding ist **HR-Produkt**—**Zeit bis produktiv** messen.

---

## Zweck

Neue Menschen **schnell** wirksam und **sicher**—Buddys nicht verbrennen.

---

## 1. Tag-1-Checkliste: Zugang und Sicherheit
...
## 2. 30-60-90: Lernziele, nicht nur Tasks
...
## 4. Single Source of Truth und Ownership
...
## 6. Feedback einholen und Onboarding verbessern
...
- **Zugangs-Chaos**—wochenlang ohne Tools; Neue steigen aus oder arbeiten unsicher auf privaten Konten.
- **Implizite Kultur**—„alle wissen“ ungeschriebene Regeln; nur Insider profitieren.
- **Buddy-Burnout**—Buddy selbst überlastet; kein Limit für Fragen oder Zeit.
- **Kein erster Erfolg**—nur Lesen wochenlang; kein Beweis, dass man dazugehört.
...
- [First Round Review — Onboarding](https://review.firstround.com/) — Essays aus der Praxis
- [GOV.UK — Joining a new team](https://www.gov.uk/government/publications/joining-a-new-team) — Orientierungsideen
- [Atlassian — Team playbook](https://www.atlassian.com/team-playbook) — Rituale und Arbeitsabreden

---

Englische Version: [`onboarding-new-team-members.md`](../../en/project-&-operations/onboarding-new-team-members.md)
