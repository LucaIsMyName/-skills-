...
- **Datenschutz**: Präferenzen; **keine** öffentliche Nennung ohne Einwilligung.
- **Wahrheit**: Wirkungsaussagen **belegbar**.

## Bevor ihr Dank sendet

### Konkret

- **Kanal**; welche **Daten** (Name, Stufe)?
- **Einwilligung** für Sichtbarkeit/Fotos.

### Meta

- Spenderbindung ist **langfristig**—jeder Kontakt baut **Vertrauen** oder schwächt es.
...
**Gut**: Konkreter Dank + Wirkung + nächstes Update.

## 2. Würdigung

**Opt-in** für Listen; **korrekte** Namen; **einfacher** Widerruf.

## 3. Was nicht tun

- **Druck** als „Dank“ tarnen.
...
- [CASE](https://www.case.org/) — Fundraising-Bildung (Programme prüfen)

---

Englische Version: [`donor-stewardship-and-thank-yous.md`](../../en/language-&-communication/donor-stewardship-and-thank-yous.md)
