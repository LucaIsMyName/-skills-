...
- **Templates** für **Markenkonsistenz**.

## Vor dem Export

### Konkret

- **Primär**-Plattformen; **Handy**-Test der Lesbarkeit.

### Meta

- Jeder **Crop** kann **Wahrheit** verzerren—**nicht** täuschen.

---

## Zweck

Assets **passend**, **lesbar**, **on-brand** ausliefern.

---

## 1. Specs vor Launch verifizieren
...
## 4. Hook und Länge für Kurzvideo
...
## 6. Ehrliche Crops — kein irreführender Ausschnitt
...
- **Zu kleiner** Fließtext in Thumbnails — auf dem Handy **unlesbar**.
- **Specs** aus Blog von 2019 — Plattformen haben **Maße** geändert.
- **Kein** Dark-Mode-Variant — weißes Logo auf weißem UI.
- **Barrierefreiheit** erst nach Launch — Nachrüsten kostet mehr.
...
- [Meta — Business help](https://www.facebook.com/business/help) — aktuelle Creative-Specs
- [W3C — WCAG Quick Reference](https://www.w3.org/WAI/WCAG22/quickref/) — filterbar nach Non-Text und Untertiteln
- [LinkedIn — Marketing solutions](https://business.linkedin.com/marketing-solutions) — Bild- und Video-Specs

---

Englische Version: [`social-media-assets.md`](../../en/media-&-production/social-media-assets.md)
