...
- **Shownotes** mit Links und **Timestamps**.
- **Musik** lizenziert; **Lautheit** plattformnah normalisieren.
...
- **Host** (RSS), **Analytics**.
- **Redaktions**richtlinie für sensible Themen.

### Meta

- **Regelmäßigkeit** schlägt **Equipment**.
...
## 1. Ein Format wählen und konsistent bleiben
...
## 4. Shownotes, Kapitel, Transkript
...
## 5. Redaktion und Umgang mit Gästen
...
- **Überkompression**—„unter Wasser“ klingende Stimme durch aggressive Rauschreduktion.
- **Keine** ID3-Tags oder Podcast-Cover—wirkt amateurhaft in Verzeichnissen.
- **Plosives** und **Zischlaute** ignoriert—schmerzhaft in Ohrhörern.
- **Clips** falsch geschnitten—Kontext in Social-Teaser verloren.
...
- [Transom — Story workshops](https://transom.org/) — Audio-Handwerk
- [Apple Podcasts — Requirements](https://podcastsconnect.apple.com/) — RSS und Metadaten
- [AES — Loudness](https://www.aes.org/) — gegen Host-Spec prüfen

---

Englische Version: [`podcasting-basics.md`](../../en/media-&-production/podcasting-basics.md)
