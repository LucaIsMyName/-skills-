...
- **Formate** pro Plattform **planen**.
- **Recht**: **Musik** lizenziert; **Locations** geklärt.

## Vor dem Dreh

### Konkret

- **Skript**/Outline; **Ablauf**; **Backup-Mikro**.
- **Einwilligung** für erkennbare Personen.

### Meta

- Im **Schnitt** wird Story **ehrlich oder irreführend**.

---

## Zweck

**Verständliches** Video—**hörbar**, **sichtbar**, **vertrauenswürdig**.

---

## 1. Ton zuerst: Mikros, Pegel, Raum
...
## 2. Licht: weich und gleichmäßig im Gesicht
...
## 3. Seitenverhältnis und Ausspielung pro Plattform
...
## 4. B-Roll für ehrlichen Kontext und Abdeckung
...
## 5. Einwilligung, Location, Musikrechte
...
## 6. Übergabe an Schnitt: Benennung und Projekt
...
## 7. Schnitt-Disziplin: Wahrheit im Schnitt
...
- **Auto-Belichtung** jagt—hell/dunkel pulsiert im Gesicht.
- **Kein** Backup-Mikro—Batterie stirbt in der Interviewmitte.
- **Vertikales** Motiv für Querformat—**Auflösung** für immer verloren.
- **Copyright-Musik** „nur intern“—landet öffentlich.
...
- [YouTube Creator Academy](https://creatoracademy.youtube.com/) — Grundlagen
- [BBC — Guidelines](https://www.bbc.co.uk/guidelines/) — Prinzipien; an eigenes Equipment anpassen
- [W3C — Media accessibility](https://www.w3.org/WAI/media/av/) — Untertitel und Audiodeskription

---

Englische Version: [`video-production-basics.md`](../../en/media-&-production/video-production-basics.md)
