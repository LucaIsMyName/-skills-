...
- **Technical**: stable exposure, **sharp** focus on eyes, **backup** cards.
- **Editorial**: captions with **names** only if approved.

## Before a shoot

### Concrete

- **Shot list** and **locations**; **model releases** ready.
- **Safeguarding** lead briefed for sensitive contexts.

### Meta

- The camera is **power**—wield it **carefully**.

---

## Purpose

Create **usable**, **ethical** images that **respect** people and **support** the story.

---

## 1. Shot list and consent before shutter
...
## 2. Dignity and representation on set
...
## 3. Technical basics: exposure, focus, backup
...
## 4. Safeguarding and sensitive contexts
...
## 5. Editorial: captions and names
...
## 6. After the shoot: rights and archive
...
- **Pay-to-pity** tropes; **undeclared** sponsorship or product placement.
- **Identifying** people in sensitive situations—**no** plan for take-down.
- **Over-editing** skin tone or context—**truth** drifts.
- **One** photographer as bottleneck—**no** handover doc for file naming.

---

## Core idea

NGO photography serves **truth and dignity**—**consent**, **context**, **care**.

## Further reading

- [DART Center — Trauma-aware reporting](https://dartcenter.org/) — sensitivity
- [NIH — Image manipulation](https://www.nih.gov/) — research integrity norms; adapt to comms honesty
- [AP — Photo guidelines](https://www.ap.org/) — editorial baseline for captions and staging

---

German version: [`fotografie-fuer-ngos.md`](../../de/medien-&-produktion/fotografie-fuer-ngos.md)
