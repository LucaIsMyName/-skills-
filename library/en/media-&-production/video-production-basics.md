...
- **Formats**: **vertical** vs **horizontal** per platform—**plan**.
- **Legal**: music **licensed**; **locations** permitted.

## Before filming

### Concrete

- **Script** or outline; **run-of-show**; **backup** mic.
- **Consent** on camera for identifiable people.

### Meta

- **Edit** is where the story becomes **honest** or **misleading**.

---

## Purpose

Ship **clear** video that people can **hear**, **see**, and **trust**.

---

## 1. Audio first: mics, levels, room
...
## 2. Lighting: soft and even on faces
...
## 3. Plan aspect ratio and delivery per platform
...
## 4. B-roll for honest context and coverage
...
## 5. Consent, location, and music rights
...
## 6. Handoff to edit: naming and project file
...
## 7. Edit discipline: truth in the cut
...
- **Auto exposure** hunting—distracting brightness pulsing on faces.
- **No** backup mic—battery dies mid-interview.
- **Vertical** subject framed for horizontal—**resolution** lost forever.
- **Copyright** music “just for internal”—leaks to public.

---

## Core idea

Video quality is **audio + light + edit discipline**—**gear** second.

## Further reading

- [YouTube Creator Academy](https://creatoracademy.youtube.com/) — fundamentals
- [BBC — Audio for video](https://www.bbc.co.uk/guidelines/) — principles; adapt to your kit
- [W3C — Media accessibility](https://www.w3.org/WAI/media/av/) — captions and description overview

---

German version: [`video-produktion-grundlagen.md`](../../de/medien-&-produktion/video-produktion-grundlagen.md)
