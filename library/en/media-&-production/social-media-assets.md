...
- **Loop** length and **hook** in first seconds for short video.
- **Brand** consistency via **templates**—not one-off chaos.

## Before exporting

### Concrete

- **Primary** platforms this month; **dark-on-light** variants if needed.
- **Compression** trade-offs—**test** on a phone.

### Meta

- **Every** resize is a chance to **crop truth**—**don’t**.

---

## Purpose

Ship assets that **fit**, **read**, and **stay on-brand**—without last-minute re-exports.

---

## 1. Verify specs before launch
...
## 4. Hook and length for short video
...
## 6. Honest crops—no misleading framing
...
- **Tiny** body text in thumbnails—**illegible** on mobile.
- **Specs** from a blog post from 2019—**platform** dimensions changed.
- **No** dark-mode variant—white logo on white in dark UI.
- **Accessibility** bolted on after launch—retrofit costs more.

---

## Core idea

Social assets are **constraints engineering**—**specs** first, **creativity** inside.

## Further reading

- [Meta — Business help](https://www.facebook.com/business/help) — current ad and creative specs
- [W3C — Understanding WCAG](https://www.w3.org/WAI/WCAG22/quickref/) — filter for non-text content and captions
- [LinkedIn — Marketing solutions](https://business.linkedin.com/marketing-solutions) — image and video specs

---

German version: [`social-media-assets.md`](../../de/medien-&-produktion/social-media-assets.md)
