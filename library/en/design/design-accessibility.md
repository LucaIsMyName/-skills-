...
Applies to the **design side of accessibility**—layout, typography, colour, motion, affordances, and patterns. Companion to [`accessibility-in-code.md`](../coding/accessibility-in-code.md) (engineering) and [`accessibility-for-comms.md`](../language-&-communication/accessibility-for-comms.md) (copy). Pair with [`color-and-contrast.md`](color-and-contrast.md), [`typography.md`](typography.md), [`motion-and-micro-interactions.md`](motion-and-micro-interactions.md).
