...
- **Deliverables** and **formats** explicit (social, print, web).
- **Mandatories** (legal lines, disclaimers, brand assets).

## Before briefing creatives

### Concrete

- **Budget** and **timeline**; **approval** path.
- **References** (style, not copy).

### Meta

- “I’ll know it when I see it” is **not** a brief.

---

## Purpose

Give creatives **constraints that liberate**—clarity beats blank slates.
...
### Bad: audience and insight

```text
General public. Make it engaging.
```

### Good: audience and insight
...
### Bad: one proposition and proof

```text
Tell them everything we do. Be bold.
```

### Good: one proposition and proof
...
### Bad: deliverables and formats explicit

```text
Social assets and stuff for the site.
```

### Good: deliverables and formats explicit
...
### Bad: mandatories and approval path

```text
Legal will look later. Use our logo.
```

### Good: mandatories and approval path
...
### Bad: budget, timeline, and references

```text
ASAP. Budget TBD. Like Apple but for charities.
```

### Good: budget, timeline, and references
...
### Bad: change control on the objective

```text
Actually we also need a video—same deadline.
```

### Good: change control on the objective
...
A creative brief answers **who**, **why**, **what truth we can show**, and **what ships**.
...
German version: [`kreativbriefs.md`](../../de/projekt-&-operationen/kreativbriefs.md)
