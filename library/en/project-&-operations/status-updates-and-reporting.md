...
- **Cadence** predictable—weekly/biweekly, not random pings.
- **Archive** updates—**onboarding** reads history.

## Before sending an update

### Concrete

- **Audience**—exec vs team; **length** budget.
- **Decisions** needed **this** week.

### Meta

- Status theatre (**everything fine**) until it explodes—**yellow early**.

---

## Purpose

Make progress and problems **visible** so help arrives **before** deadlines burn.

---

## 1. RAG or green/yellow/red with thresholds
...
## 3. Asks: decision, resource, or risk acceptance
...
## 4. Cadence and length for the audience
...
## 5. Archive where new people can read history
...
## 6. Escalate yellow before red explodes
...
- **Green-washing**—fear of looking bad hides blockers until launch.
- **Metric salad**—ten KPIs with no story; nobody knows what matters.
- **No ask**—stakeholders read and shrug; the same blockers repeat.
- **Inconsistent** RAG definitions—half the team thinks yellow means “fine”.

---

## Core idea

Status updates are **control loops**—**signal**, **ask**, **record**.

## Further reading

- [Atlassian — Status reports](https://www.atlassian.com/work-management/project-management/status-reports) — practical structure
- [GOV.UK — Reporting progress](https://www.gov.uk/service-manual/agile-delivery/reporting-progress) — RAG-style progress reporting
- [Harvard Business Review — Communication](https://hbr.org/topic/subject/communication) — pick articles deliberately; norms vary by org

---

German version: [`statusberichte-und-reporting.md`](../../de/projekt-&-operationen/statusberichte-und-reporting.md)
