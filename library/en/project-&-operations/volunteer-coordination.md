...
- **Recognition** proportionate—**thanks** and **references** (with consent).
- **Safeguarding** rules **front and centre** for roles with vulnerable people.

## Before recruiting volunteers

### Concrete

- **Supervision** model—who is **on call**?
- **Insurance** and **DBS**/background checks per role—**legal** confirms.

### Meta

- Volunteers burn out on **chaos**, not **work**.

---

## Purpose

Make volunteering **sustainable**—**clear**, **safe**, **appreciated**.

---

## 1. Role descriptions with time and skills
...
## 2. Rotas and cover—no single point of failure
...
## 4. Supervision and on-call clarity
...
## 5. Recognition and references (with consent)
...
## 6. Safeguarding and vetting front and centre
...
- **Vague** “help us” recruiting—wrong people, quick quit, resentment.
- **Hero** dependency—one volunteer holds all keys/knowledge; burnout or bus factor.
- **Guilt** trips for extra hours—erodes trust and legal goodwill.
- **Safeguarding** as an afterthought—incidents become crises and legal exposure.

---

## Core idea

Coordinate volunteers like a **system**: **roles**, **schedules**, **handovers**, **care**.

## Further reading

- [NCVO — Volunteering](https://www.ncvo.org.uk/help-and-guidance/) — UK framing; adapt locally
- [GOV.UK — Safeguarding](https://www.gov.uk/government/publications/safeguarding-guidance) — principles; pair with your local policy
- [Volunteer.gov](https://www.volunteer.gov/) — US federal volunteer hub—adapt role clarity ideas locally

---

German version: [`freiwilligen-koordination.md`](../../de/projekt-&-operationen/freiwilligen-koordination.md)
