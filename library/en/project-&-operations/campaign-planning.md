...
- **Timeline** with **dependencies** (legal, assets, translations).
- **Evaluation**: baselines, tracking links, **retrospective** date.

## Before launch

### Concrete

- **Assets** list and **approval** deadlines.
- **Risk** register (reputational, operational).

### Meta

- Campaigns fail on **handoffs**, not slogans.

---

## Purpose

Ship coordinated work that **learns**—not one-off noise.
...
### Bad: one primary objective and metric

```text
Raise awareness and get leads and build brand love—all equally important.
```

### Good: one primary objective and metric
...
### Bad: audience segments and messages

```text
Everyone in the city. Message: we’re great.
```

### Good: audience segments and messages
...
### Bad: channel plan with owners

```text
We’ll post a lot in May.
```

### Good: channel plan with owners
...
### Bad: measurement: baselines and tracking

```text
We’ll see how it went from gut feel.
```

### Good: measurement: baselines and tracking
...
### Bad: assets and approval deadlines

```text
We need some graphics and maybe a video—soon.
```

### Good: assets and approval deadlines
...
### Bad: risks and response ownership

```text
Hope nothing goes wrong on Twitter.
```

### Good: risks and response ownership
...
A campaign is a **system**: **message**, **timing**, **measurement**, **ownership**.
...
German version: [`kampagnenplanung.md`](../../de/projekt-&-operationen/kampagnenplanung.md)
