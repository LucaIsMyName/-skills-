...
- **Rotate** facilitation—**share** power.
- **Follow up** next retro—did we actually improve?

## Before the retro

### Concrete

- **Scope**: which project/timebox?
- **Participants** who did the work.

### Meta

- Retros without **follow-through** train cynicism.

---

## Purpose

Turn experience into **better defaults**—**visible** improvements, not ritual.
...
### Bad: psychological safety and boundaries

```text
“Why was Alex so slow?” (public blame)
```

### Good: psychological safety and boundaries
...
### Bad: ground in data, not only opinions

```text
60 minutes of “I feel like communication was bad.”
```

### Good: ground in data, not only opinions
...
### Bad: few actions with named owners

```text
20 sticky notes; “someone should fix docs.”
```

### Good: few actions with named owners
...
### Bad: check previous actions at the start

```text
Fresh retro every time; last commitments forgotten.
```

### Good: check previous actions at the start
...
### Bad: timebox and simple format

```text
Vent for 60 minutes, no actions.
```

### Good: timebox and simple format
...
Retros **pay rent** with **changed behaviour**—otherwise they’re theatre.
...
German version: [`retrospektiven.md`](../../de/projekt-&-operationen/retrospektiven.md)
