...
- **Show notes** with **links** and **timestamps**—accessibility and SEO.
- **Music** licensed; **levels** normalized to platform specs (-16 LUFS approx for stereo podcasts—**verify** host guidance).

## Before episode 1

### Concrete

- **Publishing** host (RSS) and **analytics** plan.
- **Editorial** policy on sensitive topics.

### Meta

- Consistency beats **gear**—**cadence** builds audience.

---

## Purpose

Publish **listenable** audio that **respects** guests and **serves** listeners.

---

## 1. Pick one format and stay consistent
...
## 4. Show notes, chapters, and transcripts
...
## 5. Editorial policy and guest care
...
## 6. Publishing stack and cadence
...
- **Over-compression**—“underwater” voice from aggressive noise reduction.
- **No** ID3 or episode art—looks amateur in directories.
- **Ignoring** **plosives** and **sibilance**—painful on earbuds.
- **Clip** misuse—context lost in social promo.

---

## Core idea

A podcast is **clarity + cadence + care**—**sound** is the product.

## Further reading

- [Transom — Story workshops](https://transom.org/) — audio craft
- [Apple Podcasts — Requirements](https://podcastsconnect.apple.com/) — RSS and metadata expectations
- [AES — Loudness recommendations](https://www.aes.org/) — verify against your host’s spec

---

German version: [`podcasting-grundlagen.md`](../../de/medien-&-produktion/podcasting-grundlagen.md)
