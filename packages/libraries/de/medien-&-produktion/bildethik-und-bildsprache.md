...
- **Kinder**/**Schutz**—besondere Vorsicht; keine identifizierenden Bilder ohne klare Regeln.
- **Caption** ehrlich—**keinen** Kontext erfinden.

## Vor dem Hero-Bild

### Konkret

- **Einwilligung** für **diesen** Kanal/Zweck.
- **Alternativen**, wenn das Motiv **Trauma zentriert**.

### Meta

- **Empathie** zeigt sich in **Auswahl und Ausschnitt**.
...
## 1. Mit Absicht zentrieren und zuschneiden
...
## 2. Agency und Systeme statt Mitleid
...
## 3. Intersectionalität und Klischees
...
## 5. Captions, die zum Bild passen
...
## 6. Einwilligung für diesen Zweck und Kanal
...
- **Zuschneiden**, um **Wasserzeichen** oder **fremde Logos** zu entfernen—Rechte und Ethik verletzt.
- **Trauma** als Ästhetik—schockierende Bilder ohne Unterstützungskontext.
- **Veralteter** Kontext—altes Foto suggeriert aktuelle Krise.
- **Einmal-Diversität**, dann wieder Default—**Vertrauen** bricht weg.
...
- [Ethics Centre — Visual ethics](https://ethics.org.au/) — Framing (sektoral anpassen)
- [DART Center — Trauma-aware reporting](https://dartcenter.org/) — Sensibilität bei Schaden
- [UNICEF — Ethical reporting on children](https://www.unicef.org/press-releases) — Grundsätze; mit lokaler Policy kombinieren

---

Englische Version: [`image-ethics-and-framing.md`](../../en/media-&-production/image-ethics-and-framing.md)
