...
- **Technik**: ruhige Belichtung, Fokus auf Augen, **Backup**-Karten.
- **Editorial**: Namen in Captions nur mit Freigabe.

## Vor dem Shooting

### Konkret

- **Shot-Liste**, **Locations**, **Model-Releases**.
- **Schutz**-Briefing bei sensiblen Kontexten.

### Meta

- Kamera ist **Macht**—vorsichtig führen.

---

## Zweck

**Brauchbare**, **ethische** Bilder, die **Menschen respektieren** und die **Story** tragen.

---

## 1. Shot-Liste und Einwilligung vor dem Auslösen
...
## 2. Würde und Repräsentation am Set
...
## 3. Technik: Belichtung, Fokus, Backup
...
## 4. Schutz und sensible Kontexte
...
## 5. Editorial: Captions und Namen
...
## 6. Nach dem Shooting: Rechte und Archiv
...
- **Mitleids-Tropes**; **nicht deklarierte** Sponsoring- oder Produktplatzierung.
- **Identifizierung** in sensiblen Situationen—**kein** Take-Down-Plan.
- **Überbearbeitung** von Hautfarbe oder Kontext—**Wahrheit** driftet.
- **Ein** Fotograf als Flaschenhals—**kein** Übergabe-Doc für Namenskonvention.
...
- [DART Center — Trauma-aware reporting](https://dartcenter.org/) — Sensibilität
- [NIH — Research integrity](https://www.nih.gov/) — Bildintegrität in der Forschung; auf Kommunikation adaptieren
- [AP — Photo guidelines](https://www.ap.org/) — redaktionelle Basis für Captions und Inszenierung

---

Englische Version: [`photography-for-ngos.md`](../../en/media-&-production/photography-for-ngos.md)
