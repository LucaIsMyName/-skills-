...
- **Zeithorizont** und **Raum**.

### Meta

- Wenn alles „transformativ“ ist, ist nichts **prüfbar**.

---

## Zweck

Teams und Förderer **einigen**, **warum** die Arbeit zählen soll—damit M&E und **Storytelling** **ehrlich** bleiben.

---

## 1. Pfad

Aktivität → Output → Outcome mit **Annahmen** in Klammern.

## 2. Annahmen

**Riskanteste** zuerst **testen**.

## 3. Was nicht tun

- **Output** mit **Impact** verwechseln ohne Belege.
...
- [NPC — Theory of change](https://www.thinknpc.org/)

---

Englische Version: [`theory-of-change.md`](../../en/research-&-analysis/theory-of-change.md)
