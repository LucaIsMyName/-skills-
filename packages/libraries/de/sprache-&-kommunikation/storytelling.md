...
- Bei echten Menschen: **Fakten, Einwilligung, Würde**.

## Vor der Lektürewahl

### Konkret

- **Kanal** (Artikel, Social, Rede, Video) und **Deadline**.

### Meta

- Bei fehlender Einwilligung oder belegten Fakten: **Stop** vor Szenenentwurf.

---

## Zweck

**Ein Einstieg** in ausführliche Storytelling-Hilfe—aufgeteilt, damit Dateien navigierbar bleiben.

---

## Teile

1. [**Storytelling: Struktur und Elemente**](storytelling-struktur-und-elemente.md) — Inputs vor dem Entwurf, Grundprinzip, fünf Elemente, Erzähler:in, vom Thema zur Story.
2. [**Storytelling: Handwerk, Sprache, Wirkung**](storytelling-handwerk-sprache-wirkung.md) — Anschaulichkeit, Dramaturgie, Organisation, Sprache, Vereinfachung, weiterlesen.
...
Englische Version: [`storytelling.md`](../../en/language-&-communication/storytelling.md)
